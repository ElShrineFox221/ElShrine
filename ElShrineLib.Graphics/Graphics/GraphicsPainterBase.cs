...
public abstract class GraphicsPainterBase
{
    ...
    protected static void OffsetDraw(Action<System.Drawing.Graphics> action, System.Drawing.Graphics graphics, ref PointF offset)
    {
        graphics.TranslateTransform((float)offset.X, (float)offset.Y);
        action.Invoke(graphics);
        graphics.TranslateTransform((float)-offset.X, (float)-offset.Y);
    }
    protected static void RotateDraw(Action<System.Drawing.Graphics> action, System.Drawing.Graphics graphics, ref PointF rotateCentre, double radian)
    {
    ...
    protected static void ScaleDraw(Action<System.Drawing.Graphics> action, System.Drawing.Graphics graphics, SizeF scale)
    {
    ...
    [Obsolete("NOT USE THIS to lines")]
    protected static void MergedDrawLines(System.Drawing.Graphics graphics, ref PointF[] p1s, ref PointF[] p2s, Pen pen)
    {
        CurveData cd = new(10);
        PointF p = new(1, 1);
        cd.SetStart(ref p);
