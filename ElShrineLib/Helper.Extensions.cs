...
namespace ElShrine
{
    public static class Extensions
    {
        ...
        public static string RemoveParts(this string str, StringComparison comparison, params IEnumerable<string> toRemoveds)
        {
            foreach(var s in toRemoveds)
            {
                str = str.Replace(s, string.Empty, comparison);
            }
            return str;
        }
        ...
        public static string RemovePartsIgnoreCase(this string str, params IEnumerable<string> toRemoveds)
            => str.RemoveParts(IgnoreCaseType, toRemoveds);
        #endregion
