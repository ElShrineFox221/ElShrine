...
namespace ElShrine.Modules
{
    ...
    public sealed class ImageSourceManager : IInitializable<ImageSourceManager>
    {
        #region Singleton
        private readonly static Lazy<ImageSourceManager> instanceLazy = new(() => new());
        public static ImageSourceManager Instance => Bootstrapper.GetInstance<ImageSourceManager>();
        public static ImageSourceManager Initialize() => instanceLazy.Value;
        #endregion
