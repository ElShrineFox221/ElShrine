...
{
    public sealed class ImageSourceManager : ISingleton<ImageSourceManager>
    {
        ...
        private static ImageSourceManager? instance = null;
        public static ImageSourceManager GetInstance() => instance ??= new ImageSourceManager();
