...
{
    [ModuleRoot(Name = "Option Hub", Version = "1.0", Tags = ["Common", "Option"], Description = "UI for options, created a visual page for user viewing and changing settings.", DataTemplateUri = "/ElShrienVisualTool;component/Modules/OptionHub/OptionHub.xaml", DataTemplateName = "OptionHubTemplate")]
