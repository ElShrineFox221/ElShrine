...
namespace ElShrine.Modules.ProcessLauncher.ViewModel
{
    [ModuleRoot(Name = "Process Launcher", Version = "1.0", Tags = ["Common", "Process"], Description = "Manager of softwares, Import .lnk and .exe files to create software info.", DataTemplateUri = "/ElShrienVisualTool;component/Modules/ProcessLauncher/ProcessLauncher.xaml", DataTemplateName = "ProcessLauncherTemplate")]
    [StartupClass]
