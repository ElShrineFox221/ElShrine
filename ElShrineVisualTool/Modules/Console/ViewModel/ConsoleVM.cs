...
{
    [ModuleRoot(Name = "Console", Version = "2.0", Tags = ["Common", "Console", "Command"], Description = "The advanced console, as implement of the IConsoleListener instead of System.Console.", DataTemplateUri = "/ElShrienVisualTool;component/Modules/Console/Console.xaml", DataTemplateName = "ConsoleTemplate", DefaultEnabled = true)]
