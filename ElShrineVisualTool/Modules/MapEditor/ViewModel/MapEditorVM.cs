...
{
    [ModuleRoot(Name = "Map Editor", Version = "1.0", Tags = ["Common", "Graph", "Map"], Description = "Map editor with 2d perlin noises and drawing pannel.", DataTemplateUri = "/ElShrienVisualTool;component/Modules/MapEditor/MapEditor.xaml", DataTemplateName = "MapEditorTemplate")]
    [StartupClass]
